...
public class PostPagenationForUser {
	...
	public static PostPageCriteria getPostPageCriteria(int pageNo, int totalPostCount, int limitPostNumPerPage,
			int buttonAmount) {
		return getPostPageCriteria(pageNo, totalPostCount, limitPostNumPerPage, buttonAmount, null, null, 0, -1, -1);
	}

	public static PostPageCriteria getPostPageCriteria(int pageNo, int totalPostCount, int limitPostNumPerPage,
			int buttonAmount, String title, String content, int authCode, int itemPriceRangeMin,
			int itemPriceRangeMax) {
