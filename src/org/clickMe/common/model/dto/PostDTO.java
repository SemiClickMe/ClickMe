...
public class PostDTO implements Serializable{
	...
	public PostDTO(int code, int sellerCode, int buyerCode, int catCode, int authCode, String content, int likeCount,
			Date time, String soldYn, int reportCount, String blindYn, int itemPrice, int view) {
		this.code = code;
	...
	public String toString() {
		return "PostDTO [code=" + code + ", sellerCode=" + sellerCode + ", buyerCode=" + buyerCode + ", catCode="
				+ catCode + ", authCode=" + authCode + ", content=" + content + ", likeCount=" + likeCount + ", time="
				+ time + ", soldYn=" + soldYn + ", reportCount=" + reportCount + ", blindYn=" + blindYn + ", itemPrice="
				+ itemPrice + ", view=" + view + "]";
	}
}
