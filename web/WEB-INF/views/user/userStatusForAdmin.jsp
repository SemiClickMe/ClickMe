				...
				<table class="table table-striped w-50 align-middle text-end">
					<tbody>
						<tr>
							...
							<td class="col-1"><input class="form-control" type="text" value="${ requestScope.userList.id }" aria-label="Id" disabled readonly></td>
						...
						<tr>
							...
							<td class="col-1"><input class="form-control" name="phoneNum" type="text" value="${ requestScope.userList.phone }" aria-label="UserPhone"></td>
						...
						<tr>
							...
							<td class="col-1"><input class="form-control" name="bdate" type="date" value="${ requestScope.userList.date }" aria-label="Userbdate"></td>
						...
						<tr>
							...
							<td class="col-1"><input class="form-control" name="deposit" type="text" value="${ requestScope.userList.deposit }" aria-label="UserDeposit"></td>
